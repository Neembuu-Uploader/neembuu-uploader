 ...
 * @author Paralytic
 */
public class TurboVideosAccount extends AbstractAccount{
    ...
    public TurboVideosAccount() {
        KEY_USERNAME = "trbovidsusername";
        KEY_PASSWORD = "trbovidspassword";
        HOSTNAME = "TurboVideos.net";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to TurboVideos.net");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfsts").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("TurboVideos.net login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("TurboVideosAccount.html", responseString);
