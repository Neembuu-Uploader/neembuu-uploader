 ...
 * @author Paralytic
 */
public class TheVideoAccount extends AbstractAccount{
    ...
    public TheVideoAccount() {
        KEY_USERNAME = "thevidusername";
        KEY_PASSWORD = "thevidpassword";
    ...
    private void initialize() throws Exception {
        ...
        //NULogger.getLogger().info("Getting startup cookies & link from TheVideo.me");
