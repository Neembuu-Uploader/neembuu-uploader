 ...
 * @author Paralytic
 */
public class ShareSixAccount extends AbstractAccount{
    ...
    public ShareSixAccount() {
        KEY_USERNAME = "shrsixusername";
        KEY_PASSWORD = "shrsixpassword";
        HOSTNAME = "ShareSix.com";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("** ShareSix.com ** => Attempting to login ...");
            httpPost = new NUHttpPost("http://sharesix.com/auth/login");
            ...
            if (responseString.contains("logout")) {
                ...
                NULogger.getLogger().info("** ShareSix.com ** => Logged in successfully!");
            } else {
                //Get error message
    ...
    private void initialize() throws Exception {
        ...
        //NULogger.getLogger().info("Getting startup cookies & link from ShareSix.com");
        //responseString = NUHttpClientUtils.getData("http://sharesix.com/", httpContext);
    }
