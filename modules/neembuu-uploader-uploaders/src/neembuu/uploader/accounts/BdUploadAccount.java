 ...
 * @author Paralytic
 */
public class BdUploadAccount extends AbstractAccount{
    ...
    public BdUploadAccount() {
        KEY_USERNAME = "bdupusername";
        KEY_PASSWORD = "bduppassword";
        HOSTNAME = "BdUpload.net";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to BdUpload.net");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfss").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("BdUpload.net login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("BdUploadAccount.html", responseString);
    ...
    private void initialize() throws Exception {
        ...
        //NULogger.getLogger().info("Getting startup cookies & link from BdUpload.net");
