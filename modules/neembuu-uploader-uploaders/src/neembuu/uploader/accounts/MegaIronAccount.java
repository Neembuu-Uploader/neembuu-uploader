 ...
 * @author Paralytic
 */
public class MegaIronAccount extends AbstractAccount{
    ...
    public MegaIronAccount() {
        KEY_USERNAME = "megaironusername";
        KEY_PASSWORD = "megaironpassword";
        HOSTNAME = "MegaIron.net";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to MegaIron.net");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfss").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("MegaIron.net login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("MegaIronAccount.html", responseString);
    ...
    private void initialize() throws Exception {
        ...
        //NULogger.getLogger().info("Getting startup cookies & link from MegaIron.net");
