 ...
 * @author Paralytic
 */
public class YaVideoAccount extends AbstractAccount{
    ...
    public YaVideoAccount() {
        KEY_USERNAME = "yavidusername";
        KEY_PASSWORD = "yavidpassword";
        HOSTNAME = "YaVideo.tv";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to YaVideo.tv");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfsts").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("YaVideo.tv login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("YaVideoAccount.html", responseString);
