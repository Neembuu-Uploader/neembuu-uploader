 ...
 * @author Paralytic
 */
public class TheFileAccount extends AbstractAccount{
    ...
    public TheFileAccount() {
        KEY_USERNAME = "theflusername";
        KEY_PASSWORD = "theflpassword";
        HOSTNAME = "TheFile.me";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to TheFile.me");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfss").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("TheFile.me login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("TheFileAccount.html", responseString);
    ...
    private void initialize() throws Exception {
        ...
        //NULogger.getLogger().info("Getting startup cookies & link from TheFile.me");
