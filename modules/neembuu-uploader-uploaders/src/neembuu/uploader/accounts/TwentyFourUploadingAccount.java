 ...
 * @author Paralytic
 */
public class TwentyFourUploadingAccount extends AbstractAccount{
    ...
    public TwentyFourUploadingAccount() {
        KEY_USERNAME = "tfupldingusername";
        KEY_PASSWORD = "tfupldingpassword";
        HOSTNAME = "24Uploading.com";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to 24Uploading.com");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfss").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("24Uploading.com login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("TwentyFourUploadingAccount.html", responseString);
