 ...
 * @author Paralytic
 */
public class PlayedToAccount extends AbstractAccount{
    ...
    public PlayedToAccount() {
        KEY_USERNAME = "plydtousername";
        KEY_PASSWORD = "plydtopassword";
        HOSTNAME = "Played.to";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to Played.to");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfsts").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("Played.to login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("PlayedToAccount.html", responseString);
