 ...
 * @author Paralytic
 */
public class UsersFilesAccount extends AbstractAccount{
    ...
    public UsersFilesAccount() {
        KEY_USERNAME = "usrsflsusername";
        KEY_PASSWORD = "usrsflspassword";
        HOSTNAME = "UsersFiles.com";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to UsersFiles.com");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfss").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("UsersFiles.com login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("UsersFilesAccount.html", responseString);
