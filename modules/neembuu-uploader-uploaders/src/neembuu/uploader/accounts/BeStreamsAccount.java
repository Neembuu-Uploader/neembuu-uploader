 ...
 * @author Paralytic
 */
public class BeStreamsAccount extends AbstractAccount{
    ...
    public BeStreamsAccount() {
        KEY_USERNAME = "bestrmsusername";
        KEY_PASSWORD = "bestrmspassword";
        HOSTNAME = "BeStreams.net";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to BeStreams.net");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfsts").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("BeStreams.net login successful!");
            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("BeStreamsAccount.html", responseString);
    ...
    private void initialize() throws Exception {
        ...
        //NULogger.getLogger().info("Getting startup cookies & link from BeStreams.net");
