 ...
 * @author Paralytic
 */
public class FilesBombAccount extends AbstractAccount{
    ...
    public FilesBombAccount() {
        KEY_USERNAME = "flsbmbusername";
        KEY_PASSWORD = "flsbmbpassword";
        HOSTNAME = "FilesBomb.in";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to FilesBomb.in");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfss").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("FilesBomb.in login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("FilesBombAccount.html", responseString);
