 ...
 * @author Paralytic
 */
public class HitFileAccount extends AbstractAccount{
    ...
    public HitFileAccount() {
        KEY_USERNAME = "hitflusername";
        KEY_PASSWORD = "hitflpassword";
        HOSTNAME = "HitFile.net";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to HitFile.net");
            httpPost = new NUHttpPost("http://hitfile.net/user/login");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "sid").isEmpty() && responseString.contains(getUsername()) ) {
                EntityUtils.consume(httpResponse.getEntity());
                loginsuccessful = true;
                username = getUsername();
                password = getPassword();
                hostsAccountUI().hostUI(HOSTNAME).setEnabled(true);
                NULogger.getLogger().info("HitFile.net login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("HitFileAccount.html", responseString);
    ...
    private void initialize() throws Exception {
        ...
        //NULogger.getLogger().info("Getting startup cookies & link from HitFile.net");
        //responseString = NUHttpClientUtils.getData("http://hitfile.net/", httpContext);
    }
