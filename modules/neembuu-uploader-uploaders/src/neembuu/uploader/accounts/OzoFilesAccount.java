 ...
 * @author Paralytic
 */
public class OzoFilesAccount extends AbstractAccount{
    ...
    public OzoFilesAccount() {
        KEY_USERNAME = "ozoflsusername";
        KEY_PASSWORD = "ozoflspassword";
        HOSTNAME = "OzoFiles.com";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to OzoFiles.com");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfss").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("OzoFiles.com login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("OzoFilesAccount.html", responseString);
    ...
    private void initialize() throws Exception {
        ...
        //NULogger.getLogger().info("Getting startup cookies & link from OzoFiles.com");
