 ...
 * @author Paralytic
 */
public class UpFourAccount extends AbstractAccount{
    ...
    public UpFourAccount() {
        KEY_USERNAME = "upfourimusername";
        KEY_PASSWORD = "upfourimpassword";
        HOSTNAME = "Up4.im";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to Up4.im");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfss").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("Up4.im login successful!");
    ...
    private void initialize() throws Exception {
        ...
        //NULogger.getLogger().info("Getting startup cookies & link from Up4.im");
        //responseString = NUHttpClientUtils.getData("Up4.im", httpContext);
    }
