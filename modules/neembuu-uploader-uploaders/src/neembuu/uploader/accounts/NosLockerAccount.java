 ...
 * @author Paralytic
 */
public class NosLockerAccount extends AbstractAccount{
    ...
    public NosLockerAccount() {
        KEY_USERNAME = "noslckrusername";
        KEY_PASSWORD = "noslckrpassword";
        HOSTNAME = "NosLocker.com";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to NosLocker.com");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfss").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("NosLocker.com login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("NosLockerAccount.html", responseString);
    ...
    private void initialize() throws Exception {
        ...
        //NULogger.getLogger().info("Getting startup cookies & link from NosLocker.com");
