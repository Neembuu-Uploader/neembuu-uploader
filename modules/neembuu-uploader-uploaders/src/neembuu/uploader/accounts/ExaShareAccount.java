 ...
 * @author Paralytic
 */
public class ExaShareAccount extends AbstractAccount{
    ...
    public ExaShareAccount() {
        KEY_USERNAME = "exashrusername";
        KEY_PASSWORD = "exashrpassword";
        HOSTNAME = "ExaShare.com";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to ExaShare.com");
            httpPost = new NUHttpPost("http://www.exashare.com/");

            List<NameValuePair> formparams = new ArrayList<NameValuePair>();
            formparams.add(new BasicNameValuePair("Field", "First Choice"));
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfsts").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("ExaShare.com login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("ExaShareAccount.html", responseString);
    ...
    private void initialize() throws Exception {
        ...
        //NULogger.getLogger().info("Getting startup cookies & link from ExaShare.com");
        //responseString = NUHttpClientUtils.getData("http://www.exashare.com/", httpContext);
    }
