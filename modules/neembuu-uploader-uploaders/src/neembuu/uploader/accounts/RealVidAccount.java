 ...
 * @author Paralytic
 */
public class RealVidAccount extends AbstractAccount{
    ...
    public RealVidAccount() {
        KEY_USERNAME = "rlvidusername";
        KEY_PASSWORD = "rlvidpassword";
        HOSTNAME = "RealVid.net";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to RealVid.net");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfsts").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("RealVid.net login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("RealVidAccount.html", responseString);
    ...
    private void initialize() throws Exception {
        ...
        //NULogger.getLogger().info("Getting startup cookies & link from RealVid.net");
        //responseString = NUHttpClientUtils.getData("http://realvid.net/", httpContext);
    }
