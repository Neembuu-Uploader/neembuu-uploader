 ...
 * @author Paralytic
 */
public class UsersCloudAccount extends AbstractAccount{
    ...
    public UsersCloudAccount() {
        KEY_USERNAME = "usrscldusername";
        KEY_PASSWORD = "usrscldpassword";
        HOSTNAME = "UsersCloud.com";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to UsersCloud.com");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfss").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("UsersCloud.com login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("UsersCloudAccount.html", responseString);
