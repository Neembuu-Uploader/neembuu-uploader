 ...
 * @author Paralytic
 */
public class LunaticFilesAccount extends AbstractAccount{
    ...
    public LunaticFilesAccount() {
        KEY_USERNAME = "lntcflusername";
        KEY_PASSWORD = "lntcflpassword";
        HOSTNAME = "LunaticFiles.com";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to LunaticFiles.com");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfss").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("LunaticFiles.com login successful!");
