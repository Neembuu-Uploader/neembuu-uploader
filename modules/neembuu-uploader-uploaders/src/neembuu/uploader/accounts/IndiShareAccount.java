 ...
 * @author Paralytic
 */
public class IndiShareAccount extends AbstractAccount{
    ...
    public IndiShareAccount() {
        KEY_USERNAME = "indishrusername";
        KEY_PASSWORD = "indishrpassword";
        HOSTNAME = "IndiShare.com";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to IndiShare.com");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfss").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("IndiShare.com login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("IndiShareAccount.html", responseString);
