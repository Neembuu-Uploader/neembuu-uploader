 ...
 * @author Paralytic
 */
public class IguanaShareAccount extends AbstractAccount{
    ...
    public IguanaShareAccount() {
        KEY_USERNAME = "igshrusername";
        KEY_PASSWORD = "igshrpassword";
        HOSTNAME = "IguanaShare.com";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to IguanaShare.com");
            httpPost = new NUHttpPost("http://www.iguanashare.com/login.html");
            ...
            if (responseString.contains("http://www.iguanashare.com/logout.html")) {
                EntityUtils.consume(httpResponse.getEntity());
                loginsuccessful = true;
                username = getUsername();
                password = getPassword();
                hostsAccountUI().hostUI(HOSTNAME).setEnabled(true);
                NULogger.getLogger().info("IguanaShare.com login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("IguanaShareAccount.html", responseString);
