 ...
 * @author Paralytic
 */
public class LetWatchAccount extends AbstractAccount{
    ...
    public LetWatchAccount() {
        KEY_USERNAME = "letwtchusername";
        KEY_PASSWORD = "letwtchpassword";
        HOSTNAME = "LetWatch.us";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to LetWatch.us");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfsts").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("LetWatch.us login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("LetWatchAccount.html", responseString);
