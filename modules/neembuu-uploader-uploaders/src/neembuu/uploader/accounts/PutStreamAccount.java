 ...
 * @author Paralytic
 */
public class PutStreamAccount extends AbstractAccount{
    ...
    public PutStreamAccount() {
        KEY_USERNAME = "putstrmusername";
        KEY_PASSWORD = "putstrmpassword";
        HOSTNAME = "PutStream.com";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to PutStream.com");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfsts").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("PutStream.com login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("PutStreamAccount.html", responseString);
