 ...
 * @author Paralytic
 */
public class FileOwnAccount extends AbstractAccount{
    ...
    public FileOwnAccount() {
        KEY_USERNAME = "flownusername";
        KEY_PASSWORD = "flownpassword";
        HOSTNAME = "FileOwn.com";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to FileOwn.com");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfss").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("FileOwn.com login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("FileOwnAccount.html", responseString);
    ...
    private void initialize() throws Exception {
        ...
        //NULogger.getLogger().info("Getting startup cookies & link from FileOwn.com");
