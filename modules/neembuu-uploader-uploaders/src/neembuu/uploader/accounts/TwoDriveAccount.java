 ...
 * @author Paralytic
 */
public class TwoDriveAccount extends AbstractAccount{
    ...
    public TwoDriveAccount() {
        KEY_USERNAME = "twodrvusername";
        KEY_PASSWORD = "twodrvpassword";
        HOSTNAME = "2Drive.net";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to 2Drive.net");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfss").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("2Drive.net login successful!");
