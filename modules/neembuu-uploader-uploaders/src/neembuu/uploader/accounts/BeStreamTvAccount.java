 ...
 * @author Paralytic
 */
public class BeStreamTvAccount extends AbstractAccount{
    ...
    public BeStreamTvAccount() {
        KEY_USERNAME = "bstrmtvusername";
        KEY_PASSWORD = "bstrmtvpassword";
        HOSTNAME = "BeStream.tv";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to BeStream.tv");
            httpPost = new NUHttpPost("http://bestream.tv/login.html");
            ...
            if (responseString.contains(getUsername()) && responseString.contains("logout")) {
                EntityUtils.consume(httpResponse.getEntity());
                loginsuccessful = true;
                username = getUsername();
                password = getPassword();
                hostsAccountUI().hostUI(HOSTNAME).setEnabled(true);
                NULogger.getLogger().info("BeStream.tv login successful!");
            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("BeStreamTvAccount.html", responseString);
