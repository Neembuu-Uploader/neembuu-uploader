 ...
 * @author Paralytic
 */
public class CloudSixAccount extends AbstractAccount{
    ...
    public CloudSixAccount() {
        KEY_USERNAME = "cldsixusername";
        KEY_PASSWORD = "cldsixpassword";
        HOSTNAME = "CloudSix.me";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to CloudSix.me");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfss").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("CloudSix.me login successful!");

            } else {
                //Get error message
                responseString = EntityUtils.toString(httpResponse.getEntity());
                //FileUtils.saveInFile("CloudSixAccount.html", responseString);
    ...
    private void initialize() throws Exception {
        ...
        //NULogger.getLogger().info("Getting startup cookies & link from CloudSix.me");
