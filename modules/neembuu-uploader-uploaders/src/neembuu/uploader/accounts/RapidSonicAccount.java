 ...
 * @author Paralytic
 */
public class RapidSonicAccount extends AbstractAccount{
    ...
    public RapidSonicAccount() {
        KEY_USERNAME = "rpdsncusername";
        KEY_PASSWORD = "rpdsncpassword";
        HOSTNAME = "RapidSonic.com";
    }
    ...
    public void login() {
        ...
        try {
            ...
            NULogger.getLogger().info("Trying to log in to RapidSonic.com");
            ...
            if (!CookieUtils.getCookieValue(httpContext, "xfss").isEmpty() && !CookieUtils.getCookieValue(httpContext, "login").isEmpty()) {
                ...
                NULogger.getLogger().info("RapidSonic.com login successful!");
