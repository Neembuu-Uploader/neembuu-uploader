...
import neembuu.uploader.accounts.SpeedVideoAccount;
 ...
 */
@SmallModule(
    exports={SpeedVideo.class,SpeedVideoAccount.class},
    interfaces={Uploader.class,Account.class},
    name="SpeedVideo.net"
)
public class SpeedVideo extends AbstractUploader implements UploaderAccountNecessary{
    
    SpeedVideoAccount speedVideoAccount = (SpeedVideoAccount) getAccountsProvider().getAccount("SpeedVideo.net");
