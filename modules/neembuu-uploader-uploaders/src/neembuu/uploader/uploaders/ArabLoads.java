...
import neembuu.uploader.accounts.ArabLoadsAccount;
 ...
 */
@SmallModule(
    exports={ArabLoads.class,ArabLoadsAccount.class},
    interfaces={Uploader.class,Account.class},
    name="ArabLoads.net"
)
public class ArabLoads extends AbstractUploader{
    
    ArabLoadsAccount arabLoadsAccount = (ArabLoadsAccount) getAccountsProvider().getAccount("ArabLoads.net");
