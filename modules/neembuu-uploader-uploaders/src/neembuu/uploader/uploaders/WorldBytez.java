...
import neembuu.uploader.accounts.WorldBytezAccount;
 ...
 */
@SmallModule(
    exports={WorldBytez.class,WorldBytezAccount.class},
    interfaces={Uploader.class,Account.class},
    name="WorldBytez.com"
)
public class WorldBytez extends AbstractUploader{
    
    WorldBytezAccount worldBytezAccount = (WorldBytezAccount) getAccountsProvider().getAccount("WorldBytez.com");
    ...
    public WorldBytez() {
        ...
        host = "WorldBytez.com";
        if (worldBytezAccount.loginsuccessful) {
            host = worldBytezAccount.username + " | WorldBytez.com";
        }
        maxFileSizeLimit = 209715200; // 200 MB (default)
        
    }

    private void initialize() throws Exception {
        responseString = NUHttpClientUtils.getData("http://worldbytez.com/", httpContext);
    ...
    public void run() {
        try {
            if (worldBytezAccount.loginsuccessful) {
                userType = "reg";
                httpContext = worldBytezAccount.getHttpContext();
                maxFileSizeLimit = 534773760; // 510 MB
            } else {
                userType = "anon";
                cookieStore = new BasicCookieStore();
                httpContext.setAttribute(ClientContext.COOKIE_STORE, cookieStore);
                maxFileSizeLimit = 209715200; // 200 MB
            }
            ...
            // http://5.104.106.202/disk12/upload.cgi?upload_id=451947896910&js_on=1&utype=anon&upload_type=file
            ...
            NULogger.getLogger().info("Now uploading your file into WorldBytez.com");
            uploading();
            ...
            if (upload_fn != null) {
                httpPost = new NUHttpPost("http://worldbytez.com/");
