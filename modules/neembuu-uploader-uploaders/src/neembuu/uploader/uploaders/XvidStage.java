...
import neembuu.uploader.accounts.XvidStageAccount;
 ...
 */
@SmallModule(
    exports={XvidStage.class,XvidStageAccount.class},
    interfaces={Uploader.class,Account.class},
    name="XvidStage.com"
)
public class XvidStage extends AbstractUploader{
    
    XvidStageAccount xvidStageAccount = (XvidStageAccount) getAccountsProvider().getAccount("XvidStage.com");
