...
import neembuu.uploader.accounts.FiveFantasticAccount;
 ...
 */
@SmallModule(
    exports={FiveFantastic.class,FiveFantasticAccount.class},
    interfaces={Uploader.class,Account.class},
    name="5Fantastic.pl",
    ignore = true

)
public class FiveFantastic extends AbstractUploader implements UploaderAccountNecessary{
    
    FiveFantasticAccount fiveFantasticAccount = (FiveFantasticAccount) getAccountsProvider().getAccount("5Fantastic.pl");
    ...
    public FiveFantastic() {
        downURL = UploadStatus.PLEASEWAIT.getLocaleSpecificString();
        delURL = UploadStatus.PLEASEWAIT.getLocaleSpecificString();
        host = "5Fantastic.pl";

        if (fiveFantasticAccount.loginsuccessful) {
            host = fiveFantasticAccount.username + " | 5Fantastic.pl";
        }
        maxFileSizeLimit = 0L; //  MB (default)        
    }
    ...
    public void run() {
        try {
            if (fiveFantasticAccount.loginsuccessful) {
                httpContext = fiveFantasticAccount.getHttpContext();
            ...
            NULogger.getLogger().info("Now uploading your file into 5Fantastic.pl");
            uploading();
