...
import neembuu.uploader.accounts.FileStormAccount;
 ...
 */
@SmallModule(
    exports={FileStorm.class,FileStormAccount.class},
...
public class FileStorm extends AbstractUploader implements UploaderAccountNecessary{
    ...
    FileStormAccount fileStormAccount = (FileStormAccount) getAccountsProvider().getAccount("FileStorm.to");
