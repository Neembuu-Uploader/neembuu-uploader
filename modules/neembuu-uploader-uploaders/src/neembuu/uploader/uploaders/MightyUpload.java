...
import neembuu.uploader.accounts.MightyUploadAccount;
 ...
 */
@SmallModule(
    exports={MightyUpload.class,MightyUploadAccount.class},
    interfaces={Uploader.class,Account.class},
    name="MightyUpload.com"
)
public class MightyUpload extends AbstractUploader{
    
    MightyUploadAccount mightyUploadAccount = (MightyUploadAccount) getAccountsProvider().getAccount("MightyUpload.com");
