...
import neembuu.uploader.accounts.RockFileAccount;
 ...
 */
@SmallModule(
    exports={RockFile.class,RockFileAccount.class},
    interfaces={Uploader.class,Account.class},
    name="RockFile.eu"
)
public class RockFile extends AbstractUploader implements UploaderAccountNecessary{
    
    RockFileAccount rockFileAccount = (RockFileAccount) getAccountsProvider().getAccount("RockFile.eu");
