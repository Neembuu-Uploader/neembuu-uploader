...
import neembuu.uploader.accounts.BdUploadAccount;
 ...
 */
@SmallModule(
    exports={BdUpload.class,BdUploadAccount.class},
    interfaces={Uploader.class,Account.class},
    name="BdUpload.net"
)
public class BdUpload extends AbstractUploader{
    
    BdUploadAccount bdUploadAccount = (BdUploadAccount) getAccountsProvider().getAccount("BdUpload.net");
    ...
    public BdUpload() {
        ...
        if (bdUploadAccount.loginsuccessful) {
            host = bdUploadAccount.username + " | BdUpload.net";
        }
    ...
    private void initialize() throws Exception {
        responseString = NUHttpClientUtils.getData("http://bdupload.net/", httpContext);
