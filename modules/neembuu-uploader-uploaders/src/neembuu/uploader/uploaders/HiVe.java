...
import neembuu.uploader.accounts.HiVeAccount;
 ...
 */
@SmallModule(
    exports={HiVe.class,HiVeAccount.class},
    interfaces={Uploader.class,Account.class},
    name="HiVe.im",
    ignore = true
)
public class HiVe extends AbstractUploader implements UploaderAccountNecessary{
    
    HiVeAccount hiVeAccount = (HiVeAccount) getAccountsProvider().getAccount("HiVe.im");
    ...
    public HiVe() {
        ...
        host = "HiVe.im";
        if (hiVeAccount.loginsuccessful) {
            host = hiVeAccount.username + " | HiVe.im";
        }
    ...
    public void run() {
        try {
            if (hiVeAccount.loginsuccessful) {
                httpContext = hiVeAccount.getHttpContext();
            ...
            NULogger.getLogger().info("Now uploading your file into HiVe.im");
            uploading();
