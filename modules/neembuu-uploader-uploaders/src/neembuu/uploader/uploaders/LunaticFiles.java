...
import neembuu.uploader.accounts.LunaticFilesAccount;
 ...
 */
@SmallModule(
    exports={LunaticFiles.class,LunaticFilesAccount.class},
    interfaces={Uploader.class,Account.class},
    name="LunaticFiles.com"

)
public class LunaticFiles extends AbstractUploader{
    
    LunaticFilesAccount lunaticFilesAccount = (LunaticFilesAccount) getAccountsProvider().getAccount("LunaticFiles.com");
    ...
    public LunaticFiles() {
        ...
        if (lunaticFilesAccount.loginsuccessful) {
            host = lunaticFilesAccount.username + " | LunaticFiles.com";
        }
        maxFileSizeLimit = 104857600L; // 100 MB (default)        
    }

    private void initialize() throws Exception {
        responseString = NUHttpClientUtils.getData("http://lunaticfiles.com/", httpContext);
    ...
    public void run() {
        try {
            if (lunaticFilesAccount.loginsuccessful) {
                userType = "reg";
                httpContext = lunaticFilesAccount.getHttpContext();
                maxFileSizeLimit = 17179869184L; // 16384 MB
            } else {
                userType = "anon";
            ...
            NULogger.getLogger().info("Now uploading your file into LunaticFiles.com");
            uploading();
            ...
            if (upload_fn != null) {
                httpPost = new NUHttpPost("http://lunaticfiles.com/");
