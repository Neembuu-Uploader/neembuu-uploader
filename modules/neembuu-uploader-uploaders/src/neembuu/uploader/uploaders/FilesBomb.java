...
import neembuu.uploader.accounts.FilesBombAccount;
 ...
 */
@SmallModule(
    exports={FilesBomb.class,FilesBombAccount.class},
    interfaces={Uploader.class,Account.class},
    name="FilesBomb.in"
)
public class FilesBomb extends AbstractUploader{
    
    FilesBombAccount filesBombAccount = (FilesBombAccount) getAccountsProvider().getAccount("FilesBomb.in");
    ...
    public FilesBomb() {
        ...
        host = "FilesBomb.in";
        if (filesBombAccount.loginsuccessful) {
            host = filesBombAccount.username + " | FilesBomb.in";
        }
    ...
    private void initialize() throws Exception {
        responseString = NUHttpClientUtils.getData("http://filesbomb.in/", httpContext);
    ...
    public void run() {
        try {
            if (filesBombAccount.loginsuccessful) {
                userType = "reg";
                httpContext = filesBombAccount.getHttpContext();
            ...
            // http://ww3.filesbomb.com/cgi-bin/upload.cgi?upload_id=509378457012&js_on=1&utype=reg&upload_type=file
            ...
            NULogger.getLogger().info("Now uploading your file into FilesBomb.in");
            uploading();
            ...
            if (upload_fn != null) {
                httpPost = new NUHttpPost("http://filesbomb.in/");
