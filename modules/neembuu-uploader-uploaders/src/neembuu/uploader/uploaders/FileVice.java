...
import neembuu.uploader.accounts.FileViceAccount;
 ...
 */
@SmallModule(
    exports={FileVice.class,FileViceAccount.class},
    interfaces={Uploader.class,Account.class},
    name="FileVice.com"
)
public class FileVice extends AbstractUploader{
    
    FileViceAccount fileViceAccount = (FileViceAccount) getAccountsProvider().getAccount("FileVice.com");
