...
import neembuu.uploader.accounts.TwentyFourUploadingAccount;
 ...
 */
@SmallModule(
    exports={TwentyFourUploading.class,TwentyFourUploadingAccount.class},
    interfaces={Uploader.class,Account.class},
    name="24Uploading.com"
)
public class TwentyFourUploading extends AbstractUploader{
    
    TwentyFourUploadingAccount twentyFourUploadingAccount = (TwentyFourUploadingAccount) getAccountsProvider().getAccount("24Uploading.com");
    ...
    public TwentyFourUploading() {
        downURL = UploadStatus.PLEASEWAIT.getLocaleSpecificString();
        delURL = UploadStatus.PLEASEWAIT.getLocaleSpecificString();
        host = "24Uploading.com";
        if (twentyFourUploadingAccount.loginsuccessful) {
            host = twentyFourUploadingAccount.username + " | 24Uploading.com";
        }
    ...
    private void initialize() throws Exception {
        responseString = NUHttpClientUtils.getData("http://24uploading.com/", httpContext);
    ...
    public void run() {
        try {
            if (twentyFourUploadingAccount.loginsuccessful) {
                userType = "reg";
                httpContext = twentyFourUploadingAccount.getHttpContext();
            ...
            // http://s3.24uploading.com/cgi-bin/upload.cgi?upload_id=
            // http://s4.24uploading.com/cgi-bin/upload.cgi?upload_id=631022878504&js_on=1&utype=reg&upload_type=file
            ...
            NULogger.getLogger().info("Now uploading your file into 24Uploading.com");
            uploading();
            ...
            if (upload_fn != null) {
                httpPost = new NUHttpPost("http://24uploading.com/");
