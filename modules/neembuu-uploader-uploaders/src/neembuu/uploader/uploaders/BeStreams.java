...
import neembuu.uploader.accounts.BeStreamsAccount;
 ...
 */
@SmallModule(
    exports={BeStreams.class,BeStreamsAccount.class},
    interfaces={Uploader.class,Account.class},
    name="BeStreams.net"
)
public class BeStreams extends AbstractUploader implements UploaderAccountNecessary{
    
    BeStreamsAccount beStreamsAccount = (BeStreamsAccount) getAccountsProvider().getAccount("BeStreams.net");
    ...
    public BeStreams() {
        ...
        host = "BeStreams.net";
        if (beStreamsAccount.loginsuccessful) {
            host = beStreamsAccount.username + " | BeStreams.net";
        }
        maxFileSizeLimit = 2621440000L; // 2,500 MB (default)
    }

    private void initialize() throws Exception {
        responseString = NUHttpClientUtils.getData("http://bestreams.net/?op=upload", httpContext);
    ...
    public void run() {
        try {
            if (beStreamsAccount.loginsuccessful) {
                httpContext = beStreamsAccount.getHttpContext();
            ...
            NULogger.getLogger().info("Now uploading your file into BeStreams.net");
            uploading();
            ...
            if (upload_fn != null) {
                httpPost = new NUHttpPost("http://bestreams.net/");
	...
	// var ext_allowed='mp4|avi|mkv|mpg|mpeg|vob|wmv|flv|mov|m2v|divx|xvid|3gp|webm|ogv|ogg';
