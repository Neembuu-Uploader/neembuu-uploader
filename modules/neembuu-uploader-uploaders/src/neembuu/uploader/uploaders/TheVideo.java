...
import neembuu.uploader.accounts.TheVideoAccount;
 ...
 */
@SmallModule(
    exports={TheVideo.class,TheVideoAccount.class},
    interfaces={Uploader.class,Account.class},
    name="TheVideo.me"
)
public class TheVideo extends AbstractUploader implements UploaderAccountNecessary{
    
    TheVideoAccount theVideoAccount = (TheVideoAccount) getAccountsProvider().getAccount("TheVideo.me");
    ...
    public TheVideo() {
        ...
        host = "TheVideo.me";
        if (theVideoAccount.loginsuccessful) {
            host = theVideoAccount.username + " | TheVideo.me";
        }
        maxFileSizeLimit = 2147483648L; // 2 GB (default)
    }

    private void initialize() throws Exception {
        responseString = NUHttpClientUtils.getData("http://www.thevideo.me/?op=upload", httpContext);
    ...
    public void run() {
        try {
            if (theVideoAccount.loginsuccessful) {
                httpContext = theVideoAccount.getHttpContext();
            ...
            // http://84.39.117.111/cgi-bin/upload.cgi?upload_id=
            // http://84.39.117.111/cgi-bin/upload.cgi?upload_id=696004044299&utype=reg&disk_id=01
            ...
            mpEntity.addPart("fakefilepc", new StringBody(""));
            ...
            NULogger.getLogger().info("Now uploading your file into TheVideo.me");
            uploading();
