...
import neembuu.uploader.accounts.FlashXAccount;
 ...
 */
@SmallModule(
    exports={FlashX.class,FlashXAccount.class},
    interfaces={Uploader.class,Account.class},
    name="FlashX.tv"
)
public class FlashX extends AbstractUploader implements UploaderAccountNecessary{
    
    FlashXAccount flashXAccount = (FlashXAccount) getAccountsProvider().getAccount("FlashX.tv");
