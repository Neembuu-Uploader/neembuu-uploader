...
import neembuu.uploader.accounts.XfileLoadAccount;
 ...
 */
@SmallModule(
    exports={XfileLoad.class,XfileLoadAccount.class},
    interfaces={Uploader.class,Account.class},
    name="XfileLoad.com"
)
public class XfileLoad extends AbstractUploader{
    
    XfileLoadAccount xfileLoadAccount = (XfileLoadAccount) getAccountsProvider().getAccount("XfileLoad.com");
