...
import neembuu.uploader.accounts.FilesTentAccount;
 ...
 */
@SmallModule(
    exports={FilesTent.class,FilesTentAccount.class},
    interfaces={Uploader.class,Account.class},
    name="FilesTent.com"
)
public class FilesTent extends AbstractUploader{
    
    FilesTentAccount filesTentAccount = (FilesTentAccount) getAccountsProvider().getAccount("FilesTent.com");
    ...
    public FilesTent() {
        ...
        host = "FilesTent.com";
        if (filesTentAccount.loginsuccessful) {
            host = filesTentAccount.username + " | FilesTent.com";
        }
        maxFileSizeLimit = 536870912L; // 512 MB (default)
        
    }

    private void initialize() throws Exception {
        responseString = NUHttpClientUtils.getData("http://filestent.com/", httpContext);
    ...
    public void run() {
        try {
            if (filesTentAccount.loginsuccessful) {
                userType = "reg";
                httpContext = filesTentAccount.getHttpContext();
            ...
            // http://up1.filestent.com/cgi-bin/upload.cgi?upload_id=465945514245&js_on=1&utype=anon&upload_type=file
            ...
            NULogger.getLogger().info("Now uploading your file into FilesTent.com");
            uploading();
            ...
            if (upload_fn != null) {
                httpPost = new NUHttpPost("http://filestent.com/");
