...
import neembuu.uploader.accounts.UpFourAccount;
 ...
 */
@SmallModule(
    exports={UpFour.class,UpFourAccount.class},
    interfaces={Uploader.class,Account.class},
    name="Up4.im"

)
public class UpFour extends AbstractUploader implements UploaderAccountNecessary{
    
    UpFourAccount upFourAccount = (UpFourAccount) getAccountsProvider().getAccount("Up4.im");
    ...
    public UpFour() {
        ...
        if (upFourAccount.loginsuccessful) {
            host = upFourAccount.username + " | Up4.im";
        }
        maxFileSizeLimit = 2147483648L; // 2048 MB (default)        
    }

    private void initialize() throws Exception {
        responseString = NUHttpClientUtils.getData("http://up4.im/", httpContext);
    ...
    public void run() {
        try {
            if (upFourAccount.loginsuccessful) {
                httpContext = upFourAccount.getHttpContext();
            ...
            // http://files1.up4.im/cgi-bin/upload.cgi?upload_id=
            // http://files1.up4.im/cgi-bin/upload.cgi?upload_id=369859278149&js_on=1&utype=reg&upload_type=file
            ...
            NULogger.getLogger().info("Now uploading your file into Up4.im");
            uploading();
            ...
            if (upload_fn != null) {
                httpPost = new NUHttpPost("http://up4.im/");
