...
import neembuu.uploader.accounts.HugeFilesAccount;
 ...
 */
@SmallModule(
    exports={HugeFiles.class,HugeFilesAccount.class},
    interfaces={Uploader.class,Account.class},
    name="HugeFiles.net"
)
public class HugeFiles extends AbstractUploader{
    
    HugeFilesAccount hugeFilesAccount = (HugeFilesAccount) getAccountsProvider().getAccount("HugeFiles.net");
