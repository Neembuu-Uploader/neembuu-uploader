...
import neembuu.uploader.accounts.FileDaisAccount;
 ...
 */
@SmallModule(
    exports={FileDais.class,FileDaisAccount.class},
    interfaces={Uploader.class,Account.class},
    name="FileDais.com"
)
public class FileDais extends AbstractUploader{
    
    FileDaisAccount fileDaisAccount = (FileDaisAccount) getAccountsProvider().getAccount("FileDais.com");
