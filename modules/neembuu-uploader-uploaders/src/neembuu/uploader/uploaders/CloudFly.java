...
import neembuu.uploader.accounts.CloudFlyAccount;
 ...
 */
@SmallModule(
    exports={CloudFly.class,CloudFlyAccount.class},
...
public class CloudFly extends AbstractUploader{
    ...
    CloudFlyAccount cloudFlyAccount = (CloudFlyAccount) getAccountsProvider().getAccount("CloudFly.us");
