...
import neembuu.uploader.accounts.GBoxesAccount;
 ...
 */
@SmallModule(
    exports={GBoxes.class,GBoxesAccount.class},
    interfaces={Uploader.class,Account.class},
    name="GBoxes.com"
)
public class GBoxes extends AbstractUploader{
    
    GBoxesAccount gBoxesAccount = (GBoxesAccount) getAccountsProvider().getAccount("GBoxes.com");
