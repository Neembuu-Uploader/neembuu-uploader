...
import neembuu.uploader.accounts.ClickToWatchAccount;
...
public class ClickToWatch extends AbstractUploader implements UploaderAccountNecessary{
    ...
    ClickToWatchAccount clickToWatchAccount = (ClickToWatchAccount) getAccountsProvider().getAccount("ClickToWatch.net");
