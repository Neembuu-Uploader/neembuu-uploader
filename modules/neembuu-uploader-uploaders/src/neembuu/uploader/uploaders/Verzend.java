...
import neembuu.uploader.accounts.VerzendAccount;
 ...
 */
@SmallModule(
    exports={Verzend.class,VerzendAccount.class},
    interfaces={Uploader.class,Account.class},
    name="Verzend.be"
)
public class Verzend extends AbstractUploader{
    
    VerzendAccount verzendAccount = (VerzendAccount) getAccountsProvider().getAccount("Verzend.be");
