...
import neembuu.uploader.accounts.VidToAccount;
 ...
 */
@SmallModule(
    exports={VidTo.class,VidToAccount.class},
    interfaces={Uploader.class,Account.class},
    name="VidTo.me"
)
public class VidTo extends AbstractUploader implements UploaderAccountNecessary{
    
    VidToAccount vidToAccount = (VidToAccount) getAccountsProvider().getAccount("VidTo.me");
