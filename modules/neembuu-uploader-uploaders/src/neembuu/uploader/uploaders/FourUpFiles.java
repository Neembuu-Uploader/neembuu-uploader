...
import neembuu.uploader.accounts.FourUpFilesAccount;
 ...
 */
@SmallModule(
    exports={FourUpFiles.class,FourUpFilesAccount.class},
    interfaces={Uploader.class,Account.class},
    name="4upFiles.com"
)
public class FourUpFiles extends AbstractUploader{
    
    FourUpFilesAccount fourUpFilesAccount = (FourUpFilesAccount) getAccountsProvider().getAccount("4upFiles.com");
