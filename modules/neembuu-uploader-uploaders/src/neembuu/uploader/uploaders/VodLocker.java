...
import neembuu.uploader.accounts.VodLockerAccount;
 ...
 */
@SmallModule(
    exports={VodLocker.class,VodLockerAccount.class},
    interfaces={Uploader.class,Account.class},
    name="VodLocker.com"
)
public class VodLocker extends AbstractUploader implements UploaderAccountNecessary{
    
    VodLockerAccount vodLockerAccount = (VodLockerAccount) getAccountsProvider().getAccount("VodLocker.com");
