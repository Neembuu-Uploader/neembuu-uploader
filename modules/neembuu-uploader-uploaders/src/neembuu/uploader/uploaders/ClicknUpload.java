...
import neembuu.uploader.accounts.ClicknUploadAccount;
 ...
 */
@SmallModule(
    exports={ClicknUpload.class,ClicknUploadAccount.class},
    interfaces={Uploader.class,Account.class},
    name="ClicknUpload.com"
)
public class ClicknUpload extends AbstractUploader{
    
    ClicknUploadAccount clicknUploadAccount = (ClicknUploadAccount) getAccountsProvider().getAccount("ClicknUpload.com");
