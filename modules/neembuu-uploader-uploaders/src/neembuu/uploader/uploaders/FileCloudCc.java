...
import neembuu.uploader.accounts.FileCloudCcAccount;
 ...
 */
@SmallModule(
    exports={FileCloudCc.class,FileCloudCcAccount.class},
    interfaces={Uploader.class,Account.class},
    name="FileCloud.cc"
)
public class FileCloudCc extends AbstractUploader{
    
    FileCloudCcAccount fileCloudCcAccount = (FileCloudCcAccount) getAccountsProvider().getAccount("FileCloud.cc");
