...
import neembuu.uploader.accounts.BlstAccount;
 ...
 */
@SmallModule(
    exports={Blst.class,BlstAccount.class},
...
public class Blst extends AbstractUploader{
    ...
    BlstAccount blstAccount = (BlstAccount) getAccountsProvider().getAccount("Bl.st");
