...
import neembuu.uploader.accounts.SafeSharingAccount;
...
public class SafeSharing extends AbstractUploader{
    ...
    SafeSharingAccount safeSharingAccount = (SafeSharingAccount) getAccountsProvider().getAccount("SafeSharing.eu");
