...
import neembuu.uploader.accounts.FileOwnAccount;
 ...
 */
@SmallModule(
    exports={FileOwn.class,FileOwnAccount.class},
    interfaces={Uploader.class,Account.class},
    name="FileOwn.com"
)
public class FileOwn extends AbstractUploader implements UploaderAccountNecessary{
    
    FileOwnAccount fileOwnAccount = (FileOwnAccount) getAccountsProvider().getAccount("FileOwn.com");
    ...
    public FileOwn() {
        ...
        host = "FileOwn.com";
        if (fileOwnAccount.loginsuccessful) {
            host = fileOwnAccount.username + " | FileOwn.com";
        }
        maxFileSizeLimit = 2147483648L; // 2 GB (default)
    }

    private void initialize() throws Exception {
        responseString = NUHttpClientUtils.getData("http://fileown.com/", httpContext);
    ...
    public void run() {
        try {
            if (fileOwnAccount.loginsuccessful) {
                userType = "reg";
                httpContext = fileOwnAccount.getHttpContext();
            ...
            // http://own002.fileown.com/cgi-bin/upload.cgi?upload_id=060603973112&js_on=1&utype=reg&upload_type=file
            ...
            NULogger.getLogger().info("Now uploading your file into FileOwn.com");
            uploading();
            ...
            if (upload_fn != null) {
                httpPost = new NUHttpPost("http://fileown.com/");
