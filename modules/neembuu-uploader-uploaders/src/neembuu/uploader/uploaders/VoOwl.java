...
import neembuu.uploader.accounts.VoOwlAccount;
...
public class VoOwl extends AbstractUploader{
    ...
    VoOwlAccount voOwlAccount = (VoOwlAccount) getAccountsProvider().getAccount("VoOwl.com");
    ...
    public VoOwl() {
        ...
        host = "VoOwl.com";
        if (voOwlAccount.loginsuccessful) {
            host = voOwlAccount.username + " | VoOwl.com";
        }
    ...
    private void initialize() throws Exception {
        responseString = NUHttpClientUtils.getData("http://voowl.com/", httpContext);
    ...
    public void run() {
        try {
            if (voOwlAccount.loginsuccessful) {
                userType = "reg";
                httpContext = voOwlAccount.getHttpContext();
            ...
            NULogger.getLogger().info("Now uploading your file into VoOwl.com");
            uploading();
            ...
            if (upload_fn != null) {
                httpPost = new NUHttpPost("http://voowl.com/");
