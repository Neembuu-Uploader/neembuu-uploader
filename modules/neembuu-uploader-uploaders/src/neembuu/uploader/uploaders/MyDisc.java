...
import neembuu.uploader.accounts.MyDiscAccount;
 ...
 */
@SmallModule(
    exports={MyDisc.class,MyDiscAccount.class},
...
public class MyDisc extends AbstractUploader{
    ...
    MyDiscAccount myDiscAccount = (MyDiscAccount) getAccountsProvider().getAccount("MyDisc.net");
