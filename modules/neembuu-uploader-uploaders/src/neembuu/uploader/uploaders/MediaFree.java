...
import neembuu.uploader.accounts.MediaFreeAccount;
 ...
 */
@SmallModule(
    exports={MediaFree.class,MediaFreeAccount.class},
    interfaces={Uploader.class,Account.class},
    name="MediaFree.co"
)
public class MediaFree extends AbstractUploader{
    
    MediaFreeAccount mediaFreeAccount = (MediaFreeAccount) getAccountsProvider().getAccount("MediaFree.co");
