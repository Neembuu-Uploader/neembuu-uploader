...
import neembuu.uploader.accounts.LomaFileAccount;
 ...
 */
@SmallModule(
    exports={LomaFile.class,LomaFileAccount.class},
...
public class LomaFile extends AbstractUploader implements UploaderAccountNecessary{
    ...
    LomaFileAccount lomaFileAccount = (LomaFileAccount) getAccountsProvider().getAccount("Lomafile.com");
