...
import neembuu.uploader.accounts.FileHootAccount;
 ...
 */
@SmallModule(
    exports={FileHoot.class,FileHootAccount.class},
    interfaces={Uploader.class,Account.class},
    name="FileHoot.com"
)
public class FileHoot extends AbstractUploader{
    
    FileHootAccount fileHootAccount = (FileHootAccount) getAccountsProvider().getAccount("FileHoot.com");
