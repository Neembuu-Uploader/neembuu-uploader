...
import neembuu.uploader.accounts.VidUpAccount;
 ...
 */
@SmallModule(
    exports={VidUp.class,VidUpAccount.class},
    interfaces={Uploader.class,Account.class},
    name="VidUp.me"
)
public class VidUp extends AbstractUploader{
    
    VidUpAccount vidUpAccount = (VidUpAccount) getAccountsProvider().getAccount("VidUp.me");
