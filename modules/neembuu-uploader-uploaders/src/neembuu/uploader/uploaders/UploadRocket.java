...
import neembuu.uploader.accounts.UploadRocketAccount;
 ...
 */
@SmallModule(
    exports={UploadRocket.class,UploadRocketAccount.class},
    interfaces={Uploader.class,Account.class},
    name="UploadRocket.net"
)
public class UploadRocket extends AbstractUploader{
    
    UploadRocketAccount uploadRocketAccount = (UploadRocketAccount) getAccountsProvider().getAccount("UploadRocket.net");
