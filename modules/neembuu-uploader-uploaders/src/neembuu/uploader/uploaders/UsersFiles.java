...
import neembuu.uploader.accounts.UsersFilesAccount;
 ...
 */
@SmallModule(
    exports={UsersFiles.class,UsersFilesAccount.class},
    interfaces={Uploader.class,Account.class},
    name="UsersFiles.com"
)
public class UsersFiles extends AbstractUploader{
    
    UsersFilesAccount usersFilesAccount = (UsersFilesAccount) getAccountsProvider().getAccount("UsersFiles.com");
    ...
    public UsersFiles() {
        ...
        host = "UsersFiles.com";
        if (usersFilesAccount.loginsuccessful) {
            host = usersFilesAccount.username + " | UsersFiles.com";
        }
    ...
    public void run() {
        try {
            if (usersFilesAccount.loginsuccessful) {
                userType = "reg";
                httpContext = usersFilesAccount.getHttpContext();
            ...
            // https://up11.usersfiles.com/cgi-bin/upload.cgi?upload_id=150081733085&js_on=1&utype=anon&upload_type=file
            httpPost = new NUHttpPost(uploadURL);
            MultipartEntity mpEntity = new MultipartEntity(HttpMultipartMode.BROWSER_COMPATIBLE, null, Charset.forName("UTF-8"));
            mpEntity.addPart("upload_type", new StringBody("file"));
            mpEntity.addPart("sess_id", new StringBody(sessionID));
            mpEntity.addPart("srv_tmp_url", new StringBody(srv_tmp_url));
            mpEntity.addPart("undefined_descr", new StringBody("Uploaded via NeembuuUploader!"));
            ...
            NULogger.getLogger().info("Now uploading your file into UsersFiles.com");
            uploading();
            ...
            if (upload_fn != null) {
                httpPost = new NUHttpPost("https://usersfiles.com/");
