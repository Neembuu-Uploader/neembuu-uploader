...
import neembuu.uploader.accounts.PrivateFilesAccount;
 ...
 */
@SmallModule(
    exports={PrivateFiles.class,PrivateFilesAccount.class},
    interfaces={Uploader.class,Account.class},
    name="PrivateFiles.com",
    ignore = true
)
public class PrivateFiles extends AbstractUploader implements UploaderAccountNecessary{
    
    PrivateFilesAccount privateFilesAccount = (PrivateFilesAccount) getAccountsProvider().getAccount("PrivateFiles.com");
